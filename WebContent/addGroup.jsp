...
<link type="text/css" rel="stylesheet" href="assets/css/addGroup.css" />
...
<body>
	...
	<div class="container" style="margin-top: 80px;">
		...
		<form class="form-horizontal">
			...
			<input type="text" class="form-control" id="groupName" placeholder="나만의 스터디모임의 이름을 정해주세요.">

			<div class="input-header">모임인원 <label for="maxMember" class="col-sm-2 control-label">모임인원</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
						<div class="input-inner-text-container">
							<span class="noselect">월</span><input id="money" type="text" name="money" value="0"><span class="noselect">원</span>
						</div>
			...
			<!-- 모임스케줄 -->
			<div class="form-group">
				<label for="groupSchedule" class="col-sm-2 control-label">모임 스케줄</label>
				<div class="col-sm-10">
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							<tr>
								<td>
									<select class="form-group lessonTime start-time" name="mon" name="mon">
									...
									<span class="divisionLine">~</span><br />
			...
			<div class="form-group">
				<label for="tel" class="col-sm-2 control-label">대표 연락처</label>
				<div class="col-sm-10">
					<input type="tel" class="form-control" id="tel" placeholder="대표 연락처를 입력해주세요.">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<label class="checkbox-inline"><input type="checkbox"
						id="toeic" value="toeic">토익</label> <label class="checkbox-inline"><input
						type="checkbox" id="opic" value="opic">오픽</label> <label
						class="checkbox-inline"><input type="checkbox"
						id="toeicSpeaking" value="toeicSpeaking">토익스피킹</label> <label
						class="checkbox-inline"> <input type="checkbox"
				...
				<div class="col-sm-10">
					<label class="checkbox-inline"><input type="checkbox"
						id="japanese" value="japanese">일본어 </label> <label
						class="checkbox-inline"><input type="checkbox"
						id="chinese" value="chinese">중국어 </label> <label
						class="checkbox-inline"><input type="checkbox" id="french"
						value="french">프랑스어 </label> <label class="checkbox-inline">
						<input type="checkbox" id="otherLanguage" value="otherLanguage">기타
						언어
					</label>
				</div>
				...
				<div class="col-sm-10">
					<label class="checkbox-inline"><input type="checkbox"
						id="inlineCheckbox1" value="option1">인적성</label> <label
						class="checkbox-inline"><input type="checkbox"
						id="inlineCheckbox2" value="option2">면접 </label> <label
						class="checkbox-inline"><input type="checkbox"
						id="inlineCheckbox3" value="option3">자기소개서 </label> <label
						class="checkbox-inline"><input type="checkbox"
						id="inlineCheckbox4" value="option4">기타 </label>
				</div>
				...
				<div class="col-sm-10">
					<label class="checkbox-inline"><input type="checkbox"
						id="inlineCheckbox1" value="option1">공무원</label> <label
						class="checkbox-inline"><input type="checkbox"
						id="inlineCheckbox2" value="option2">국가고시</label> <label
						class="checkbox-inline"><input type="checkbox"
						id="inlineCheckbox3" value="option3">기타</label>
				</div>
			</div>
			<!-- //카테고리 -->
			...
			<!-- 가입질문 -->
			<div class="form-group">
				<label for="question" class="col-sm-2 control-label">모임 가입 질문</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label for="groupImage" class="col-sm-2 control-label">이미지 선택</label>
				<div class="col-sm-10">
			...
			<!-- 장소등록 -->
			<div class="form-group">
				<a href="#" data-toggle="modal" data-target="#inputPlace_modal"><button
				class="btn btn-default">장소등록</button></a>
			</div>
			<div class="form-group">
				<label for="introduce" class="col-sm-2 control-label">모임 소개</label>
				<div class="col-sm-10">
					<textarea class="form-control" rows="8" placeholder="나만의 모임을 자유롭게 소개해주세요."></textarea>
				</div>
			</div>

			<div class="pull-right">
				<button type="button" class="btn next-btn last-step" value="800">스터디 등록하기</button>
			</div>
		</form>
