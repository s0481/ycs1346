				...
				<div class="modal-content">
					<form id="Join-Form">
						...
						<div class="modal-body">
							...
							<div class="controls">
								<label class="control-label" for="성별">성별</label> <label
							...
							<div class="controls">
								<label class="control-label" for="영어">영어</label> <label
							...
							<div class="controls">
								<label class="control-label" for="외국어">외국어</label> <label
									class="checkbox-inline"> <input type="checkbox"
									value="일본어">일본어
								</label><label class="checkbox-inline"> <input type="checkbox"
									value="중국어">중국어
							...
							<div class="controls">
								<label class="control-label" for="취업">취업</label> <label
									class="checkbox-inline"> <input type="checkbox"
									value="인적성">인적성
								</label><label class="checkbox-inline"> <input type="checkbox"
									value="면접">면접
							...
							<div class="controls">
								<label class="control-label" for="국가고시/공무원">국가고시/공무원</label> <label
									class="checkbox-inline"> <input type="checkbox"
									value="공무원">공무원
								</label><label class="checkbox-inline"> <input type="checkbox"
									value="국가고시">국가고시
